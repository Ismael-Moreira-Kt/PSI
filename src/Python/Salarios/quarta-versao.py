...
irsTotal = 0
descontoSsTotal = 0
subsidioAlimentacaoPagoTotal = 0
...
for i in range(numeroFuncionarios):
    ...
    impostoSeloTotal += impostoSelo 
    irsTotal += irs
    descontoSsTotal += descontoSs 
    subsidioAlimentacaoPagoTotal += subsidioAlimentacaoPago 
    salarioLiquidoTotal += salarioLiquido
    seguroSaudeTotal += seguroSaude


gastoFinal = impostoSeloTotal + irsTotal + descontoSsTotal + subsidioAlimentacaoPagoTotal + salarioLiquidoTotal


print("Este mês será gasto {}.\n\tIRS: {}\n\tImposto de Selo: {}\n\tDesconto para a Segurança Social: {}\n\tSeguro de Saúde: {}\n\tSubsidio de Alimentação: {}\n\t\tSalário Liquido: {}" .format(gastoFinal, irsTotal, impostoSeloTotal, descontoSsTotal, seguroSaudeTotal, subsidioAlimentacaoPagoTotal, salarioLiquidoTotal))